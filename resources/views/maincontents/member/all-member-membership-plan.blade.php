               ...
               <table id="<?=((count($rows)>0)?'simpletable':'')?>" class="table table-striped table-bordered nowrap">
                  <thead>
                     <tr>
                        ...
                        <th scope="col">Current Membership Plan</th>
                  ...
                  <tbody class="table-border-bottom-0">
                     <?php if($rows){ $sl=1; foreach($rows as $row){?>
                        <tr>
                            ...
                            <td>
                              <span class="badge bg-primary"><?=$row->package_name?></span><br>
                            ...
                            <td>
                              ...
                              <?php }?><br><br>
                              <a target="_blank" href="<?=url($controllerRoute . '/membership-history/'.Helper::encoded($row->user_id))?>" class="btn btn-outline-info btn-sm" title="Membership History"><i class="fa fa-list"></i>&nbsp;Membership History</a>
                            </td>
                        </tr>
                     <?php } }?>
                  </tbody>
